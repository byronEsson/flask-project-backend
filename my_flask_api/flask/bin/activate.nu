...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/byron/northcoders/projects/flask-project-backend/my_flask_api/flask'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/byron/northcoders/projects/flask-project-backend/my_flask_api/flask/bin/deactivate.nu'
